...
public class GridPlayer : Pathfinding
{
	...
	public bool isDead;
	public bool hasBosco;
	public MeshRenderer mr;
	public static float whateverYouWant;
	...
	private void MoveMethod()
	{
		if (Path.Count > 0)
		{
			...
			transform.position = Vector3.MoveTowards(transform.position, transform.position + direction, Time.deltaTime * whateverYouWant);
